...
def animate(i):
    graph_data = open('E:\Py\Redes Neuronales\samplefile.txt','r').read()
    lines = graph_data.split('\n')
    xs = []
    ys = []
    edit = open('E:\Py\Redes Neuronales\samplefile.txt','a')
...
ani = animation.FuncAnimation(fig,animate,interval = 1000)#1000ms = 1 second
plt.show()
